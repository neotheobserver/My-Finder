...
#define CUSTOM_STYLE_PROPS_COUNT  16
...
#define CUSTOM_STYLE_FONT_ATLAS_COMP_SIZE 1860

// Font atlas image pixels data: DEFLATE compressed
static unsigned char customFontData[CUSTOM_STYLE_FONT_ATLAS_COMP_SIZE] = { 0xed,
...
static const Rectangle customFontRecs[189] = {
    { 4, 4, 4 , 16 },
    { 16, 4, 1 , 11 },
    { 25, 4, 3 , 3 },
    { 36, 4, 6 , 11 },
...
static const GlyphInfo customFontGlyphs[189] = {
    { 32, 0, 14, 4, { 0 }},
    { 33, 1, 3, 3, { 0 }},
    { 34, 1, 3, 5, { 0 }},
    { 35, 1, 3, 8, { 0 }},
...
static void GuiLoadStyleCustom(void)
{
    // Load style properties provided
    // NOTE: Default properties are propagated
    for (int i = 0; i < CUSTOM_STYLE_PROPS_COUNT; i++)
    {
        GuiSetStyle(customStyleProps[i].controlId, customStyleProps[i].propertyId, customStyleProps[i].propertyValue);
    }

    // Custom font loading
    // NOTE: Compressed font image data (DEFLATE), it requires DecompressData() function
    int customFontDataSize = 0;
    unsigned char *data = DecompressData(customFontData, CUSTOM_STYLE_FONT_ATLAS_COMP_SIZE, &customFontDataSize);
    ...
    memcpy(font.recs, customFontRecs, font.glyphCount*sizeof(Rectangle));

    // Copy font char info data from global fontChars
    // NOTE: Required to avoid issues if trying to free font
    font.glyphs = (GlyphInfo *)RAYGUI_MALLOC(font.glyphCount*sizeof(GlyphInfo));
    memcpy(font.glyphs, customFontGlyphs, font.glyphCount*sizeof(GlyphInfo));
    ...
    GuiSetStyle(SCROLLBAR, SCROLL_SLIDER_SIZE, 30); 
}
